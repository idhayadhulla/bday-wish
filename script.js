...
// 		gameBoard.innerHTML="I LIKE YOU SEETHALAKSHMI!";
// gameBoard.innerHTML="I Luv YOU SEETHALAKSHMI!";
...
function checkGameOver() {
    if (matched == products.length / 2) {
        ...
        // Show "I love you" for 1 second
        gameBoard.innerHTML = "I LOVE YOU SEETHALAKSHMI!";
        setTimeout(function() {
            // After 1 second, if "I like you" hasn't been shown yet, show it
            if (!loveMessageShown) {
                gameBoard.innerHTML = "I LIKE YOU SEETHALAKSHMI! WISH YOU MANY MORE HAPPY BIRTHDAY DEAR";
                loveMessageShown = true; // Set flag to true
            }
